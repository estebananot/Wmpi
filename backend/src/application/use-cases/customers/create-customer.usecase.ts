...
export class CreateCustomerUseCase {
  ...
  async execute(dto: CreateCustomerDto): Promise<Result<CustomerResponseDto, Error>> {
    try {
      ...
      return Result.fail(error instanceof Error ? error : new Error('Failed to create customer'));
    }
  }
}
